...
def train_model(parameter_dictionary):
    ...
    model = models.PerSequenceClassificationLoraKCNE1(parameter_dictionary, tokenizer).bfloat16().to(device)
    ...
    outmodel_name = 'KCNE1_' + str(trial_num) + '.pt'
...
if __name__ == '__main__':
    ...
    training_set = models.PerSequenceClassificationLoraDataset(train_df, tokenizer, KCNE1_MAX_LEN, SEQUENCE_COL, LABEL_NAME, N_LABELS)
    validation_set = models.PerSequenceClassificationLoraDataset(val_df, tokenizer, KCNE1_MAX_LEN, SEQUENCE_COL, LABEL_NAME, N_LABELS)
    testing_set = models.PerSequenceClassificationLoraDataset(test_df, tokenizer, KCNE1_MAX_LEN, SEQUENCE_COL, LABEL_NAME, N_LABELS)
