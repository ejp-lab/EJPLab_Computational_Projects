...
class PerSequenceClassificationLoraKCNE1(torch.nn.Module):

    def __init__(self, hyperparameters_dictionary, tokenizer):
        super(PerSequenceClassificationLoraKCNE1, self).__init__()
        ...
        self.encoder = AutoModel.from_pretrained('facebook/esm2_t33_650M_UR50D')
