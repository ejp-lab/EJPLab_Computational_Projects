...
class PerSequenceClassificationLoraKCN1(torch.nn.Module):

    def __init__(self, hyperparameters_dictionary):
        super(PerSequenceClassificationLoraKCN1, self).__init__()

        self.embedding_shape = 5120
        ...
        self.encoder = AutoModel.from_pretrained("facebook/esm2_t48_15B_UR50D")
